<template>
  <div class="min-h-screen bg-design-page-bg text-design-page-text">
    <div class="mx-auto max-w-7xl px-4 py-4">
      ...
      <div
        class="mt-4 flex justify-end gap-2 border-t border-design-border-subtle pt-4"
      >
        <button
          type="button"
...
function addCreature(creature: any) {
  const existing = selectedCreatures.value.find(
...
function removeCreature(creatureId: string) {
  selectedCreatures.value = selectedCreatures.value.filter(
